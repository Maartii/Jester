...
**Note: Currently it's not possible to play with the Jester on in more than one lobby at the same time (on the same private server). Will add support for that soon!**
