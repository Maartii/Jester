# Jester
*Jester* is a plugin for the Among Us private server [Impostor](https://github.com/Impostor/Impostor) that adds a special Jester-role to the game. When the Jester gets voted out during a meeting, the Jester wins and everyone else loses. 
